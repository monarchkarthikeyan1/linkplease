...
class Settings(BaseSettings):
    PSEUDOGRAM_BASE_URL: str = os.getenv("PSEUDOGRAM_BASE_URL", os.getenv("MOCK_API_BASE_URL", "https://pseudogram-api.onrender.com"))
    PSEUDOGRAM_API_KEY: str = os.getenv("PSEUDOGRAM_API_KEY", os.getenv("API_KEY", ""))
    ...
    def MOCK_API_BASE_URL(self) -> str:
        return self.PSEUDOGRAM_BASE_URL
